...
import { ProjectIcon, OrgIcon } from './components/IconComponents';

type ViewType = 'project' | 'organization';
      ...
      <main className="container mx-auto p-4 sm:p-6 lg:p-8">
        ...
        {structuredData && !isLoading && (
          <div>
            ...
            {activeView === 'project' ? (
                <ProjectView data={structuredData} />
            ) : (
                <OrganizationView data={structuredData} />
            )}
          </div>
        )}
      </main>
